  public class Main {
    ...
    {
      PictureTester tester = new PictureTester();

      /** Uncomment for A3: */ 
      // Picture pix1 = new Picture("images/motivation.jpg");
      // Picture scaledPix1 = pix1.scale(0.2,0.2);
      // scaledPix1.write("images/scaledMotivation");
      // scaledPix1.explore();
